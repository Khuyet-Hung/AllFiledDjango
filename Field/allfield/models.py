...
class Field(models.Model ):
    ...
    # file_filed =  models.FileField(default='',verbose_name="File Field", help_text="File Field", error_messages="Vui lòng nhập lại")
    ...
    # image_filed =  models.ImageField(verbose_name="Image Field", help_text="Image Field", error_messages="Vui lòng nhập lại")
